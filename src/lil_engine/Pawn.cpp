...
// Model *Pawn::GetModel() { return Lil::Resources().GetModel(m_model_key); }
// std::string &Pawn::ModelKey() {return m_model_key;}

// void Pawn::AddBoundBoxCollider() {
//     AddBoundsBoxColliderToBody(m_body, *Lil::Resources().GetModel(m_model_key));
// }

// void Pawn::AddBoundBoxColliderMulty() {
//     AddBoundsBoxColliderToBodyMulty(m_body, *Lil::Resources().GetModel(m_model_key));
// }

// void Pawn::AddBoundSphereCollider() {
//     AddBoundingSphereColliderToBody(m_body, *Lil::Resources().GetModel(m_model_key));
// }

...
target_link_libraries(lil_engine PUBLIC raylib)

# r3d
set(R3D_DIR ${CMAKE_SOURCE_DIR}/include/external/r3d-0.11.0)
find_package(assimp REQUIRED)
set(R3D_RAYLIB_VENDORED OFF CACHE BOOL "" FORCE)
set(R3D_ASSIMP_VENDORED OFF CACHE BOOL "" FORCE)
add_subdirectory(${R3D_DIR} ${CMAKE_BINARY_DIR}/r3dBuild)

target_link_libraries(lil_engine PUBLIC r3d)
target_include_directories(lil_engine PUBLIC
    ${R3D_DIR}/include
)
